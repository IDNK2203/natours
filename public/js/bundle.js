...
exports.updatePassword = exports.updateUserData = void 0;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            (0, _alerts.showAlert)('success', 'Your settings have been updated!');
            window.setTimeout(function () {
              location.assign('/me');
            }, 1500);
            _context.next = 17;
...
var updatePassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(password, newPasswordConfirm, newPassword) {
    var res, data;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return fetch('http://localhost:3000/api/v1/users/updatepassword', {
              method: 'PATCH',
              headers: {
                'Content-Type': 'application/json'
              },
...
if (passwordForm) passwordForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    var passwordBtn, newPassword, password, newPasswordConfirm;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            passwordBtn = passwordForm.querySelector('.btn').textContent = 'UPDATING PASSWORD';
            newPassword = passwordForm.querySelector('#password').value;
            password = passwordForm.querySelector('#password-current').value;
            newPasswordConfirm = passwordForm.querySelector('#password-confirm').value;
            console.log(password, newPasswordConfirm, newPassword);
            _context.next = 8;
            return (0, _updateSettings.updatePassword)(password, newPasswordConfirm, newPassword);
